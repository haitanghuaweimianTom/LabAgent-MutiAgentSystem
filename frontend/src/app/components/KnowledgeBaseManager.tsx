...
export default function KnowledgeBaseManager() {
  ...
  const actionBtnBase = "inline-flex items-center gap-3 min-h-[38px] px-4 py-2.5 bg-muted border border-border rounded-lg text-muted-foreground text-sm cursor-pointer transition-colors duration-150 whitespace-nowrap hover:bg-accent hover:text-foreground";
    ...
    <div className="flex h-full min-h-[500px] bg-card border border-border rounded-xl shadow-sm overflow-hidden">
      ...
      <div className="w-72 shrink-0 flex flex-col border-r border-border bg-muted/50">
        <div className="flex items-center justify-between pl-5 pr-6 h-14 border-b border-border shrink-0 gap-3">
          ...
          <button className="inline-flex items-center justify-center min-h-[38px] px-5 py-2.5 bg-primary border border-primary rounded-lg text-primary-foreground text-sm cursor-pointer font-semibold transition-opacity hover:opacity-90" onClick={() => setShowCreateBase(true)}>+ 新建</button>
        </div>
