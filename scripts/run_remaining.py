#!/usr/bin/env python3
"""Run 7 remaining templates one-by-one with 10s cooldown between each."""
...
TEMPLATES = [
    ("icml_2024", "We propose a causal bandit algorithm with O(sqrt(T)) regret bound using instrumental variables."),
    ("aaai_2024", "Multi-agent reinforcement learning for warehouse robot coordination with heterogeneous agents."),
